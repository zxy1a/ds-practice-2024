...
class SuggestionsStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.BookSuggestions = channel.unary_unary(
                '/suggestions.Suggestions/BookSuggestions',
...
def add_SuggestionsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'BookSuggestions': grpc.unary_unary_rpc_method_handler(
                    servicer.BookSuggestions,
...
class Suggestions(object):
    ...
    def BookSuggestions(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/suggestions.Suggestions/BookSuggestions',
